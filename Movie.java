public final class Movie implements Comparable<Movie>
{
	...
	*/
	...
	public int compareTo(Movie anotherMovie)
	{
		int comparison;
		return 
		(comparison=this.movieTitle.compareToIgnoreCase(anotherMovie.getMovieTitle())) == 0 ?
		this.imdbID.compareToIgnoreCase(anotherMovie.getImdbID()):
		comparison;
	}
	@Override
	public boolean equals(Object o)
	{
		...
		if(o==null || o instanceof Movie)
			return false;
		Movie anotherMovie=(Movie)o;
		return this.imdbID.equalsIgnoreCase(anotherMovie.getImdbID()) && this.movieTitle.equalsIgnoreCase(anotherMovie.getMovieTitle());
	}
	@Override
	...
	public int hashCode()
	{
		return (this.imdbID.hashCode()+this.movieTitle.hashCode())*31;
	}
}